...
h0_list = np.linspace(0.2e-3, 0.6e-3, 15)
st_list = np.linspace(10e-3, 100e-3, 15)  # sigma from 0.01 to 0.1 in 5 steps
viscosity_list = [1e-2]
L_list = np.linspace(1e-2, 1e-1, 15)  # L from 0.2 to 1.0 in 5 steps
theta_s_list = [17.4]
kappa_list = [2.2e-4]


folder = r"C:\Users\zl948\Documents\WPM"
